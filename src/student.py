...
class Student:
    def __init__(self, root):  # CONSTRUCTOR CALLED root represents the main Tkinter window
        ...
        current_course = LabelFrame(
            Left_frame, bd=2, bg=self.colors['primary'], relief=RIDGE,
        ...
        # ------------------ Semester ------------------
        semester_label = Label(current_course, text="Semester",
                               font=("Helvetica", 12, "bold"),
                               bg=self.colors['primary'], fg="white")
        ...
        semester_combo["values"] = (
            "Select Semester", "Semester 1", "Semester 2", "Semester 3",
        ...
        # ------------------ Course ------------------
        course_label = Label(current_course, text="Course",
                             font=("Helvetica", 12, "bold"),
                             bg=self.colors['primary'], fg="white")
        ...
        # ------------------ Student ID ------------------
        studentId_label = Label(student_info, text="Student ID",
                                font=("Helvetica", 12, "bold"),
                                bg=self.colors['primary'], fg="white")
        studentId_label.grid(row=0, column=0, padx=10, pady=5, sticky=W)

        studentId_entry = ttk.Entry(student_info, width=20,
                                    textvariable=self.var_std_id,
                                    font=("Helvetica", 12, "bold"))
        studentId_entry.grid(row=0, column=1, padx=10, pady=5, sticky=W)

        # ------------------ Student Name ------------------
        studentName_label = Label(student_info, text="Student Name",
                                  font=("Helvetica", 12, "bold"),
                                  bg=self.colors['primary'], fg="white")
        studentName_label.grid(row=0, column=2, padx=10, pady=5, sticky=W)

        studentName_entry = ttk.Entry(student_info, width=20,
                                      textvariable=self.var_std_name,
                                      font=("Helvetica", 12, "bold"))
        studentName_entry.grid(row=0, column=3, padx=10, pady=5, sticky=W)

        # ------------------ Class Roll No ------------------
        classRoll_label = Label(student_info, text="Class Roll No",
                                font=("Helvetica", 12, "bold"),
                                bg=self.colors['primary'], fg="white")
        classRoll_label.grid(row=1, column=0, padx=10, pady=5, sticky=W)

        classRoll_entry = ttk.Entry(student_info, width=20,
                                    textvariable=self.var_roll,
                                    font=("Helvetica", 12, "bold"))
        classRoll_entry.grid(row=1, column=1, padx=10, pady=5, sticky=W)

        # ------------------ Gender ------------------
        gender_label = Label(student_info, text="Gender",
                             font=("Helvetica", 12, "bold"),
                             bg=self.colors['primary'], fg="white")
        ...
        Button(row1, text="Save", command=self.add_data, width=15,
               font=("Helvetica", 12, "bold"),
               bg=self.colors['success'], fg="white").pack(side=LEFT, padx=10)

        Button(row1, text="Update", command=self.update_data, width=15,
               font=("Helvetica", 12, "bold"),
               bg=self.colors['primary'], fg="white").pack(side=LEFT, padx=10)

        Button(row1, text="Delete", command=self.delete_data, width=15,
               font=("Helvetica", 12, "bold"),
               bg=self.colors['danger'], fg="white").pack(side=LEFT, padx=10)

        Button(row1, text="Reset", command=self.reset_data, width=15,
               font=("Helvetica", 12, "bold"),
        ...
        Button(row2, text="Take Photo Sample", command=self.generate_dataset,
               width=20, font=("Helvetica", 12, "bold"),
               bg=self.colors['bg_dark'], fg="white").pack(side=LEFT, padx=20)

        Button(row2, text="Update Photo Sample",
               width=20, font=("Helvetica", 12, "bold"),
               bg=self.colors['bg_card'], fg="white").pack(side=LEFT, padx=20)
        ...
        search_lbl = Label(Right_frame, text="Search System",
                           font=("Helvetica", 12, "bold"),
                           bg=self.colors['primary'], fg="white")
        ...
        search_entry = ttk.Entry(search_frame, width=18,
                                 font=("Helvetica", 12, "bold"))
        search_entry.pack(side=LEFT, padx=5)

        Button(search_frame, text="Search", width=10,
               font=("Helvetica", 12, "bold"),
               bg=self.colors['bg_dark'], fg="white", bd=0).pack(side=LEFT, padx=5)

        Button(search_frame, text="Show All", width=10,
               font=("Helvetica", 12, "bold"),
               bg=self.colors['bg_dark'], fg="white", bd=0).pack(side=LEFT, padx=5)
        ...
        self.student_table = ttk.Treeview(
            table_frame,
            columns=("dep", "course", "year", "sem", "id", "name", "roll", "gender",
            ...
            try:
                ...
                my_cursor.execute(
                    ...
                    (self.var_dep.get(), self.var_course.get(), self.var_year.get(),
                     self.var_semester.get(), self.var_std_id.get(),
                     self.var_std_name.get(), self.var_roll.get(), self.gender_var.get(),
            ...
            try:
                ...
                if Update > 0:
                    ...
                    my_cursor.execute(
                        ...
                        "roll_no=%s, gender=%s, dob=%s, email=%s, phone=%s, address=%s, teacher=%s, "
                        ...
                        (self.var_dep.get(), self.var_course.get(), self.var_year.get(),
                         ...
                         self.var_photo_sample.get(), self.var_std_id.get())
                    )
